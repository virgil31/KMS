...
$query_user = "
    ...
    FROM sf_guard_user A
      LEFT JOIN kms_event_tag B ON (A.id = B.target_id AND B.type like 'user')
...
$query_oi = "
    ...
    FROM st_information_source A
        ...
        LEFT JOIN kms_event_tag G ON (A.id = G.target_id AND G.type like 'information_source')
...
$query_pa = "
    ...
    FROM st_archaeo_part A
         ...
         LEFT JOIN kms_event_tag F ON (A.id = F.target_id AND F.type like 'archaeo_part')
...
$query_collection = "
    ...
    FROM kms_collection A
        ...
        LEFT JOIN kms_event_tag D ON (A.id = D.target_id AND D.type like 'collection')
...
$query_event = "
    ...
    FROM kms_event A
        ...
        LEFT JOIN kms_event_tag D ON (A.id = D.target_id AND D.type like 'event')
