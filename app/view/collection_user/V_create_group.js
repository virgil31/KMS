            ...
            items:[
                {
                    ...
                    listeners: {
                        specialkey: function(me,e){
                            if (e.getKey() === e.ENTER){
                                Ext.ComponentQuery.query('collection_user_create_group button[action=do_query]')[0].fireEvent("click");
                            }
                        }
                    }
                },
                    ...
                    listeners:{
                        click: function () {
                            var store = Ext.StoreManager.lookup("S_user_pool"),
                                query = Ext.ComponentQuery.query("collection_user_create_group textfield[name=query]")[0].getValue();
                            ...
                            handler: function (grid, rowIndex) {
                                ...
                                Ext.Msg.confirm("Info","Sicuro di voler aggiungere tutti gli utenti nel gruppo:<br> <b>"+pool_name+"</b>?",function (btnId) {
                                    if(btnId == "yes"){
                                        ...
                                        Ext.ComponentQuery.query("collection_user_create_group")[0].close();
                                    }
                                });
                            }
                        }
