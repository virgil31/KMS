Ext.define('CL.view.collection_tag.V_create', {
    extend: 'Ext.window.Window',
    xtype: 'collection_tag_create',
    itemId: 'collection_tag_create_id',
    alias: 'widget.collection_tag_create',
    ...
    title: 'Aggiungi TAG alla Collezione',
