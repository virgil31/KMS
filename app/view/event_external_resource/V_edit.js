Ext.define('CL.view.event_external_resource.V_edit', {
    extend: 'Ext.window.Window',
    xtype: 'event_external_resource_edit',
    itemId: 'event_external_resource_edit_id',
    alias: 'widget.event_external_resource_edit',
