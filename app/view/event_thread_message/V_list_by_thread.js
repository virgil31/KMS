Ext.define('CL.view.event_thread_message.V_list_by_thread', {
    extend: 'Ext.panel.Panel',
    xtype: 'event_thread_message_list_by_thread',
    itemId: 'event_thread_message_list_by_thread_id',
    alias: 'widget.event_thread_message_list_by_thread',
                            ...
                            items: [
                                {
                                    ...
                                    cls: 'mybutton',
                                    handler: function () {
                                        Ext.ComponentQuery.query("event_thread_message_list_by_thread grid")[0].getStore().reload();
                                    }
                                }
                            ]
                        },
                            ...
                            items: [
                                {
                                    ...
                                    handler: function () {
                                        ...
                                        var thread_record = CL.app.getController("C_event_thread_message").thread_record;

                                        CL.app.getController("C_event_thread").share(targetEl,thread_record);
                                    }
                                }
                            ]
                        },
                            ...
                            items: [
                                {
                                    ...
                                    handler: function(){
                                        var thread_record = CL.app.getController("C_event_thread_message").thread_record,
                                            event_id = thread_record.get("event_id");
            ...
            items:[
                {
                    ...
                    bbar:[
                        ...
                        {
                            xtype: 'pagingtoolbar',
                            store: 'S_event_thread_message', // same store GridPanel is using
                            dock: 'bottom',
                            displayInfo: true
                        }
                    ],
