Ext.define('CL.view.collection_external_resource.V_create', {
    extend: 'Ext.window.Window',
    xtype: 'collection_external_resource_create',
    itemId: 'collection_external_resource_create_id',
    alias: 'widget.collection_external_resource_create',
