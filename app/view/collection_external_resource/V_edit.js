Ext.define('CL.view.collection_external_resource.V_edit', {
    extend: 'Ext.window.Window',
    xtype: 'collection_external_resource_edit',
    itemId: 'collection_external_resource_edit_id',
    alias: 'widget.collection_external_resource_edit',
